...
def update_bullets(bullets):
    '''Обновляет позиции пуль и уничтожает старые пути'''
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Создание пришельца и вычисление количества пришеьцев в ряду
    alien = Alien(ai_settings, screen)
...
def check_flet_edges(ai_settings, aliens):
...
def update_aliens(ai_settings, aliens):
    ...
    после чего обновяет позиции всех пришельцев во флоте
    '''
    check_flet_edges(ai_settings, aliens)
    aliens.update()
